...
class Marshaller:
    ...
    def dump_tensor(self,value,write):
        write("<value><tensor>")
        write(escape(repr(pickle.dumps(value))))
        write("</tensor></value>\n")
    dispatch[torch.Tensor] = dump_tensor
...
class Unmarshaller:
    ...
    def end_tensor(self, data):
        if self._encoding:
            data = data.decode(self._encoding)
        data = eval(data)
        self.append(pickle.loads(data))
        self._value = 0
    dispatch["tensor"] = end_tensor
